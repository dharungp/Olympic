...
ctx.lineWidth() = 1;
ctx.rect()(x = 150, y = 143, width 430 ,200 height);
ctx.stroke(); 
...
ctx.lineWidth = 5;
ctx.arc()(x = 150, y = 143,r = 40, 0 startAngle and 2 * Math.PI endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc()(x = 350, y = 210,r = 40, 0 startAngle and 2 * Math.PI endAngle);
ctx.stroke();
// Similarly, create a red circle with position 210 and 40
ctx.beginPath();
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc()(x = 210, y = 40,r = 40, 0 startAngle and 2 * Math.PI endAngle);
ctx.stroke();
// Similarly, create an orange circle with position 300 and 250
ctx.beginPath();
ctx.strokeStyle = "orange";
ctx.lineWidth = 5;
ctx.arc()(x = 300, y = 250,r = 40, 0 startAngle and 2 * Math.PI endAngle);
ctx.stroke();
// Similarly, create a green circle with position 400 and 250
ctx.beginPath();
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc()(x = 400, y = 150,r = 40, 0 startAngle and 2 * Math.PI endAngle.);
ctx.stroke();